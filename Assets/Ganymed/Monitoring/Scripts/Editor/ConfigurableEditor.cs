...
namespace Ganymed.Monitoring.Editor
{
    ...
    public class ConfigurableEditor : UnityEditor.Editor
    {
        ...
        protected void DrawStyleInspector(string title = "Config")
        {
            ...
            {
                configurable.prefixFontSize = EditorGUILayout.Slider(
                    "Prefix",
                    configurable.prefixFontSize,
                    rightValue: Configurable.MAXFONTSIZE,
                    leftValue: Configurable.MINFONTSIZE);
    
                configurable.infixFontSize = EditorGUILayout.Slider(
                    "Infix",
                    configurable.infixFontSize,
                    rightValue: Configurable.MAXFONTSIZE,
                    leftValue: Configurable.MINFONTSIZE);
    
                configurable.suffixFontSize = EditorGUILayout.Slider(
                    "Suffix",
            ...
            {
                configurable.fontSize = EditorGUILayout.Slider(
                    "Fontsize",
            ...
            if (GUI.changed) configurable.Validate(UnityEventType.ManuallyInvoked);
